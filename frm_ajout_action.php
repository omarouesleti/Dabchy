...
require 'produit.php';
$message = '';
if (isset ($_POST['name'])  && isset($_POST['image']) && isset($_POST['price'])&& isset($_POST['cathegories'])&& isset($_POST['type'])&& isset($_POST['balance'])) {
  $name = $_POST['name'];
  $image = $_POST['image'];
  $price = $_POST['price'];
  ...
  $sql =  'INSERT INTO tbl_product(name, image ,price ,cathegories ,type ,balance) VALUES(:name, :image, :price , :cathegories , :type , :balance)';
  $statement = $connect->prepare($sql);
  if ($statement->execute([':name' => $name, ':image' => $image,':price' => $price,':cathegories' => $cathegories,':type' => $type,':balance' => $balance])) {
    ...
    <div class="card-body">
      ...
      <form method="post" >
        ...
        <div class="form-group">
          ...
          <!-- <input type="text" name="image" id="name" class="form-control" required> -->
        ...
        <div class="form-group">
          ...
          <input type="text" name="cathegories" id="name" class="form-control" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" name="balance" id="email" class="form-control">
        </div>
        <div class="form-group">
