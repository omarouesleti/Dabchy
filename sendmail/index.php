...
" id="col">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <li class="nav-item">
                <a class="nav-link "href="">SEND MAIL <i class="fas fa-envelope"></i></a>
...
?> 
  ...
  <div class="card mt-5" style="background-color:">
    ...
    <div class="card-body">
      ...
      <?php endif; ?>
      <form method="post" action="../sendmail/config.php">
		...
		<i class="fas fa-address-book"></i>
          ...
          <input type="text" name="sujet" id="name" class="form-control" required>
        </div>
        <div class="md-form">
  <i class="fas fa-pencil-alt prefix"></i>
  <textarea id="form10" name="message" class="md-textarea form-control" rows="3" required></textarea>
