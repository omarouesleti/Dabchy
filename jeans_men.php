...
<div id="demo" class="carousel slide" data-ride="carousel" style="margin-top: ">
  ...
  <div class="carousel-inner z-depth-5">
    <div class="carousel-item active">
      ...
      <div class="carousel-caption">
        <h1 style="color: #000000;text-transform: uppercase;font-size: 45px;">Men's wear</h1>
        <p style="color: #000000 ;text-transform: uppercase;font-size: 18px;">We had such a great time in LA!</p>
      </div>   
    </div>
    <div class="carousel-item">
      <img src="img/image3.jpg" alt="Chicago" width="1100" height="500">
      <div class="carousel-caption">
        <h1 style="color: #000000;text-transform: uppercase;font-size: 45px;">Men's wear</h1>
        <p style="color: #000000 ;text-transform: uppercase;font-size: 18px;">We had such a great time in LA!</p>
      </div>   
