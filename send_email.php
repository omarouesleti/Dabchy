...
?> 
  ...
  <div class="card mt-5" style="background-color:">
    <div class="card-header bg-dark" style="margin-top:18px;">
    ...
    <div class="card-body">
      ...
      <form method="post" >
        ...
        <div class="form-group">
          ...
          <input type="text" name="image" id="name" class="form-control">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" name="cathegories" id="name" class="form-control">
        </div>
        <div class="form-group">
